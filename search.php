        ...
        <nav class="align-center" id="dawgdrops">
            <div class="dawgdrops-inner container">
                <ul class="dawgdrops-nav" id="menu-brand-menu">
                    ...
                    <li class="dawgdrops-item">
                        ...
                        <ul class="dawgdrops-menu dawgdrops-menu-em" id="menu-104">
                            <li>
                                ...
                                title="Applied Computing">Applied Computing</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="dawgdrops-item">
                        <button type="submit"><a href="https://depts.washington.edu/stemadv/autumn-2021/search.php"><i class="fa fa-search"></i></a></button>                  
                    </li>
                </ul>
            </div>
        </nav>
        
        <h1>Autumn 2021 Capstone & Symposium</h1>
        <h2>December 17, 2021</h2>
        <hr>
    </header>
        ...
        if ($mysqli_connection->connect_error){
            ...
            if ($keywordfromform != '') {
                ...
                if ($search_type == "student-name") {
                    $query_cmd = "SELECT project_id FROM autumn2021 WHERE student_name LIKE '%".$keywordfromform."%'";
                } else if ($search_type == "project-title") {
                    $query_cmd = "SELECT project_id FROM autumn2021 WHERE project_title LIKE '%".$keywordfromform."%'";
                } else {
                    $query_cmd = "SELECT project_id FROM autumn2021 WHERE faculty_advisor LIKE '%".$keywordfromform."%'";
                }
